...
export abstract class BaseService<TClass, TFilter extends BaseFilter> {
    ...
    public create(item: TClass): Observable<TClass> {
        return this.http
            .post<TClass>(`${this.apiUrl}${this.controller}/`, item)
            .pipe((map) => {
                return map;
            });
    }
    ...
    public getAll(filter: TFilter): Observable<GetAllResponde<TClass>> {
        ...
        return this.http.get<TClass[]>(`${this.apiUrl}${this.controller}/`,
            {
                params: params,
                observe: 'response'
            },
    ...
    public update(item: TClass, id: number): Observable<TClass> {
        return this.http
            .patch<TClass>(`${this.apiUrl}${this.controller}/${id}`, item)
            .pipe((map) => {
                return map;
            });
    }
    ...
    public delete<TClass>(id: number | string): Observable<TClass> {
        return this.http
            .delete<TClass>(`${this.apiUrl}${this.controller}/` + id)
            .pipe((map) => {
                return map;
            });
    }
